            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">View / Edit Footer contact</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                    ...
                                    <div class="row"><div class="col-sm-12"><table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA odd" role="row">
                                                <td class="sorting_1">
                                                <?php echo $slider_data[$i]['link_id'];?>
                                                     
                                                  
                                                </td>
                                                <td>
                                               <?php echo $slider_data[$i]['link_name'];?>
                                                </td>
                                                <td>

                                                    <a href="<?php echo ADMIN_PATH; ?>edit-footer-contact-item?itemid=<?php echo $slider_data[$i]['link_id'];?>"><button type="button" class="btn btn-info btn-circle 2x" alt="edit"
