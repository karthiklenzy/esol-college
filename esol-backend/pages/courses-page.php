                                ...
                                <div class="dataTable_wrapper">
                                    ...
                                    <div class="row"><div class="col-sm-12"><table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                                        <thead>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 300px;">Course</th>
                                        ...
                                        if ($events_data) {
                                         ...
                                         ?>
                                            ...
                                            <tr class="gradeA odd" role="row">
                                                <td>
                                                  <?php echo $events_data[$i]['course_id']; ?>  
                                                </td>
                                                <td>
                                                  <?php echo $events_data[$i]['course_name']; ?>  
                                                </td>
                                                
                                                <td>

                                                    <a href="<?php echo ADMIN_PATH; ?>edit-course?courseid=<?php echo $events_data[$i]['course_id']; ?>" title="Edit"><button type="button" class="btn btn-info btn-circle 2x" alt="Edit"><i class="fa fa-edit"></i></button></a>

                                                    <a href="<?php echo ADMIN_PATH;?>courses?courseid=<?php echo $events_data[$i]['course_id']; ?>" title="" onclick="return confirm('Are you sure you want to this news?')"><button type="button" class="btn btn-danger btn-circle 2x" name="btn-delete" alt="Delete"><i class="fa fa-trash" name="btn-active" title=""></i></button></a>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <a href="<?php echo ADMIN_PATH;?>add-course">
                                                <button type="button" class="btn btn-outline btn-info">Add course</button>
                                            </a> 
                                        </div>
                                    </div>
