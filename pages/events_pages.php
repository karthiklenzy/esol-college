<div class="content">
		<div class="container">
			    <!-- **************Mobile MENU start************ -->
				<?php if(isMobile()){ ?>
				<div class="info-h3 sm-device">
						<!-- <h3 class="single">Events List</h3> -->
						<button type="button" class="btn abt-btn" data-toggle="collapse" data-target="#demo">&emsp;EVENTS<i class="fa fa-chevron-down"></i></button>
						<div id="demo" class="collapse">
				<?php } ?>
					<aside id="sidebar" class="sm-device">
						<div class="widget sidemenu" style="padding-bottom: 0">
							<ul>
							<?php
							if ($event_data) {
			...
			<!-- *******************MENU START******************** -->
			<aside id="sidebar">
				<div class="widget sidemenu lg-device">
					<ul>
					<?php
					if ($event_data) {
						for ($i=0; $i < count($event_data); $i++) {
