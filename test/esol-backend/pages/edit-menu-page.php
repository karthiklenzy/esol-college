            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">View / Edit Menu</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="row"><div class="col-sm-12"><table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                                        ...
                                        <tbody>
                                            ...
                                            if ($slider_data) {
                                               ...
                                               // $header_id = filter_var([$i]['header_id'], FILTER_SANITIZE_STRING);
                                               // $header_name = filter_var([$i]['header_name'], FILTER_SANITIZE_STRING);
                                              
                                            ?>
                                            <tr class="gradeA odd" role="row">
                                                <td class="sorting_1">
                                                  <?php echo $slider_data[$i]['main_menu_id'] ; ?>
                                                </td>
                                                <td>
                                                  <?php echo $slider_data[$i]['main_menu_name']?>
                                                </td>
                                                <td>

                                                    <a href="<?php echo ADMIN_PATH;?>edit-menu-item?linkid=<?php echo $slider_data[$i]['main_menu_id'];?>"><button type="button" class="btn btn-info btn-circle 2x" alt="edit"
                                                    ><i class="fa fa-edit"></i></button></a>
                                                    
                                                    <a href="<?php echo ADMIN_PATH;?>edit-menu?deleteid=<?php echo $slider_data[$i]['main_menu_id'];?>" onclick="return confirm('Are you sure you want to delete this?')">
                                                ...
                                                <?php 
                                                 ...
                                                 $number_of_header_links = count($slider_data);
                                            }
                                                ?>
                                ...
                                if ($number_of_header_links < 6) {
                                
                                ?>   
                                
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <a href="<?php echo ADMIN_PATH;?>add-menu-link">
                                                <button type="button" class="btn btn-outline btn-info">Add menu link</button>
                                            </a> 
                                        </div>
                                    </div>
                                <?php
                                ...
                                ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="alert alert-danger">You can add only 6 links</div>
                                        </div>
                                    </div>
                                <?php 
