...
$(function() {
        ...
        $( "#myDatePicker_start" ).datepicker({ dateFormat: 'yy-mm-dd', changeYear: true, yearRange: "-100:+0"}); 
     
     });
        $(function() {
         // Just one method to add a date picker!
        $( "#myDatePicker_end" ).datepicker({ dateFormat: 'yy-mm-dd', changeYear: true, yearRange: "-100:+0"}); 
