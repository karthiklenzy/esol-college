            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">View / Edit Footer</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                    ...
                                    <div class="row"><div class="col-sm-12"><table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA odd" role="row">
                                                <td class="sorting_1">
                                                <?php echo $sql[$i]['footer_id'];?>
                                                     
                                                  
                                                </td>
                                                <td>
                                               <?php echo $sql[$i]['footer_heading'];?>
                                                </td>
                                                <td>

                                                    <a href="<?php echo ADMIN_PATH.$sql[$i]['page_link']; ?>"><button type="button" class="btn btn-info btn-circle 2x" alt="edit"
