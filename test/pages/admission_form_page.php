						...
						<?php if (isset($_COOKIE['SuccessMessage'])) {?>
							...
							<div class="form_div child_new form_margin_top" style="margin-top: 10px !important;width: 100%;">
								...
								<h5 id="line_1">Child #1&emsp;</h5>
								  ...
								  <div class="form-group col-md-6">
								  <label>Term Test Mark in English</label>
							  ...
							  <div class="form-row form_button_div">
								  ...
								  <div class="form-group col-md-6">
								<a id='addButton' class="btn btn-primary add_mar add_margin" style="color: white;width: auto;margin-right: 13px;float: right;"><i class="fas fa-user-plus" name="add-child"></i>&emsp;Add Child</a>
								</div>
